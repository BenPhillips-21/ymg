    ...
    <Main>
      <div className="p-4 flex flex-col md:flex-row">
        <div className="md:w-1/2 md:pr-4">
          <h1 className={`text-xl lg:text-2xl font-bold mb-4 ${montserrat.className}`}>
            YMG Origins
          </h1>
          <p className={`text-xs lg:text-l mb-5 ${montserrat.className}`}>
            When Fr Ken Barker MGL was in Assisi in the Jubilee Year 2000 praying
            in the xsall church where St Francis and his brothers spent much of
            their time, he sensed the Lord wanted a movement of young men in
            Australia, which would spread also to other countries.
          </p>
          <p className={`text-xs lg:text-l mb-4 ${montserrat.className}`}>
        ...
        <div className="md:w-1/2 flex flex-col items-center justify-center">
          <Image
            ...
            className="mb-2"
          />
          <h1 className={`text-center ${montserrat.className}`}>
            Fr Ken Baker
          </h1>
        </div>
      </div>
