...
export default function OurMission() {
    return (
      <section className="flex flex-col items-center justify-center max-w-full px-4 py-8 mx-auto space-y-4">
        <h1 className={`${montserrat.className} text-[#1c272c] text-4xl lg:text-6xl font-bold text-center underline`}>Our Mission</h1> 
        <h1 className={`${montserrat.className} text-2xl lg:text-4xl text-[#1c272c] text-center leading-relaxed`}>  
