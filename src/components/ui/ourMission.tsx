...
export default function OurMission() {
    return (
      <section className="flex flex-col items-center justify-center max-w-full px-4 py-8 mx-auto space-y-4">
        <h1 className={`${ebGaramond.className} text-[#333652] text-4xl lg:text-6xl font-bold text-center underline`}>Our Mission</h1> 
        <h1 className={`${ebGaramond.className} text-2xl lg:text-4xl text-[#333652] text-center leading-relaxed`}>  
